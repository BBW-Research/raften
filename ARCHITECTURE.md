...
The bootstrap checker in `tools/` is a frozen source fixture, not the production architecture. The standalone package lives under `src/raften/` and must not import repository-specific code or assume its own checkout layout.
