...
The bootstrap checker in `tools/` is a frozen source fixture, not the target architecture. The target package lives under `src/repo_context/` and must not import repository-specific code or assume its own checkout layout.
