...
from raften.command_paths import validate_command_path
from raften.config import ConfigurationError, render_starter_policy, starter_policy
from raften.debt import capture_debt_manifest, debt_manifest_path, render_debt_manifest
...
from raften.model import InventoryEntry, MigrationDebtManifest, SizeEvaluation
from raften.run_model import CommandFailure, InitOutcome, InitResult, RunStatus
from raften.size_policy import compile_size_policy
from raften.sizes import content_paths_for_evaluation, evaluate_sizes


def initialize_repository(
    repository_path: str | Path,
    *,
    config_path: str | Path = "raften.toml",
