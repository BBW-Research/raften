...
from raften.init_recovery import (
    _Artifact,
    _PreparedArtifact,
    _metadata_identity,
...
from raften.init_safety import _fail, _open_parent
...
def _prepare_artifact(
    ...
    *,
    ...
    try:
        ...
        temporary_name = f".{target_name}.raften-{token}.tmp"
        backup_name = f".{target_name}.raften-{token}.bak" if existed else None
        removal_name = f".{target_name}.raften-{token}.rollback"
