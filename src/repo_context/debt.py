...
from repo_context.config_validation import child_path
from repo_context.matcher import candidate_path_validation_error, path_validation_error
...
def parse_debt_manifest(
    data: bytes,
    *,
    source_path: str = "repo-context.debt.json",
) -> MigrationDebtManifest:
