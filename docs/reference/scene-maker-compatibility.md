...
| Canonical configured and candidate paths, including bounded unsafe-input errors | `tests/test_config_invalid_semantics.py`, `tests/test_inventory_failures.py`, and `tests/test_cli_integration.py` | Intended improvement |
