...
- [Scene-maker migration](migration/index.md): translate the bootstrap JSON policy to version 1 TOML without preserving bypasses.
- [Pilot results](pilots/index.md): isolated qualification evidence from representative repositories.
- [Specifications](specs/index.md): authoritative product and CLI contract.
